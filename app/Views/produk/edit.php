...
<div class="card">
  ...
  <div class="card-body">
    <!-- Start: Edit Data Produk -->
    <form id="u_produk" method="post" action="Javascript:Update();">
      <?= csrf_field() ?>
      <input type="hidden" name="en_cover" id="en_cover" value="<?= $produk["coverproduk"]; ?>">
      <div class="form-group row">
        <label for="en_kode" class="col-sm-4 col-form-label">Kode Produk</label>
        <div class="col-sm-4">
          <input type="text" class="form-control" id="en_kode" name="en_kode" value="<?= $produk["kodebarcode"]; ?>" readonly>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control" id="en_produk" name="en_produk" value="<?= $produk["namaproduk"]; ?>">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-4">
          <input type="text" class="form-control" id="en_stok" name="en_stok" value="<?= $produk["stok_tersedia"]; ?>">
        ...
        <div class="col-sm-4">
          <select class="form-control" id="en_kategori" name="en_kategori">
            <?php foreach($kategori as $kat) : ?>
              <?php if($kat['katid'] == $produk["produk_katid"]) : ?>
        ...
        <div class="col-sm-4">
          <select class="form-control" id="en_satuan" name="en_satuan">
            <?php foreach($satuan as $sat) : ?>
              <?php if($sat['satid'] == $produk["produk_satid"]) : ?>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-4">
          <input type="text" class="form-control" id="en_beli" name="en_beli" value="<?= $produk["harga_beli"]; ?>" style="text-align: right;">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-4">
          <input type="text" class="form-control" id="en_jual" name="en_jual" value="<?= $produk["harga_jual"]; ?>" style="text-align: right;">
          <small class="text-danger e-jual"></small>
        </div>
      </div>
      <div class="form-group row">
        <label for="new_cover" class="col-sm-4 col-form-label">Cover Lama (<i>Jika ada</i>)</label>
        <div class="col-sm-1">
          <img src="/gambar/<?= $produk["coverproduk"]; ?>" style="width: 100px; height: 100px; border:1px solid black;">
        </div>
      </div>
      <div class="form-group row">
        <label for="new_cover" class="col-sm-4 col-form-label">Upload Cover (<i>Jika ada</i>)</label>
        <div class="col-sm-4">
          <input type="file" class="form-control" id="new_cover" name="new_cover">
          <small class="text-danger e-new-cover"></small>
        </div>
      </div>
